...
export default function Home() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!receipt) return setError("Upload a receipt before submitting the claim");
