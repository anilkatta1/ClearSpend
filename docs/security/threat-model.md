...
| Parser abuse / decompression bomb | Exact MIME/format checks, Pillow verification, 25 MP image cap, single-frame image rule, 20-page PDF cap, encrypted/active/embedded PDF rejection | OS-level resource quotas and adversarial corpus fuzzing |
