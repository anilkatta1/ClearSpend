...
| H6 | ₹3,000–₹10,000/month is plausible. | Direct buyer pricing conversations. | Packaging and pricing. |
...
| Relationships | Self-serve trial plus assisted policy setup and periodic effectiveness review. |
...
| Revenue | Organization subscription with included assessments; usage tier; optional later onboarding fee. |

Key commercial hypotheses: value tracks claim volume and time saved; account/usage pricing is preferable to seats; acceptable setup is under one hour; accountant distribution is later, not MVP-critical.
...
**Pilot — ₹4,999/company/month:** 100 assessments, 5 reviewers/admins, unlimited submitters, versioned policy, citations, approval trail, basic export, email support.

**Team — ₹9,999/company/month:** 500 assessments, 15 reviewers/admins, unlimited submitters, analytics, extended retention, priority support, future integration allowance.

These are research starting points, not validated prices.

### Metric and evidence

Use a base subscription with included assessment volume: it aligns with workload and variable cost, stays predictable, and does not penalize submitter adoption.

Ask economic buyers about claim volume, reviewer hours/cost, errors/delay, existing spend, and prices that feel inexpensive/reasonable/expensive/too expensive. Ask for a conditional 30-day pilot commitment. Compliments are not WTP evidence; a pilot, buyer introduction, safe test cases, or written intent is stronger.
...
- support/onboarding allocation
- payment processing
= contribution margin
```

Measure tokens/calls and show low/base/high scenarios. Do not invent margins.

### Rejected alternative

**Per-seat pricing** is rejected initially because occasional approvers and submitters increase adoption, while workload and direct variable cost follow assessments more closely. Revisit if buyer evidence shows finance-seat budgeting is strongly preferred.
